...
const uint16_t cleaning_cancleIR[131] = {
...
void sendCleaningIR(){
    Serial.println("청소 시작/정지 IR신호 발생");
    irsend.sendRaw(cleaning_cancleIR, 131, 38);  // Send a raw data capture at 38kHz.
}
