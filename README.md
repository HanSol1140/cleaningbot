...
ESP8285는 코드 업로드시 IP 0과 우측의 GND부분을 연결하여 전압을 0V로 만들어야 플래시 모드로 부팅되어 코드를 업로드할 수 있습니다.
...
![image](https://github.com/HanSol1140/cleaningbot/assets/121269266/1254c54a-f03f-4147-9a80-36f5b14084c0)
